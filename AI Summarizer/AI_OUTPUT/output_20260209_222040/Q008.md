...
- Q8.1 What a "gap in the PD spec" actually means
- Q8.2 Why synthetic simulation is uniquely suited to find gaps
- Q8.3 Step 1 - Encode the spec as rules, not prose
- Q8.4 Un-encodable prose = spec ambiguity
