...
- Q2.1 Design goals for a USB-PD synthetic data schema
- Q2.2 Think of this as “PD scenario as data”, not just logs.
- Q2.3 Core schema (conceptual JSON)
- Q2.4 Versioning
- Q2.5 Traceability
- Q2.6 Dataset curation
- Q2.7 Each layer is independently evolvable
- Q2.8 High-level schema layers
- Q2.9 Represent protocol, electrical, timing, and state context together
- Q2.10 Be spec-aligned, not free-form text
- Q2.11 Support fault injection + expected outcome labeling
